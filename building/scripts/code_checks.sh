...
cppcheck /temporary/code --enable=all --error-exitcode=1 -I /temporary/code/include -I /temporary/code/src  -I /usr/include/apriltag/ --suppress=missingIncludeSystem